function HeroText() {
  return (
    <div className="mb-28 mt-20 flex flex-col gap-6">
      <h1 className="z-10 font-bold text-4xl sm:text-5xl lg:text-7xl text-center tracking-wide">
        Your Only <span className="text-blue-400">Quiz Hub</span>.
      </h1>
      <p className="z-10 mx-2 text-base lg:text-lg text-center text-neutral-400 max-w-2xl font-medium">
