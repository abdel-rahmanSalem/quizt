...
function Button({ children, type, onClick }) {
  ...
  const commonClasses =
    "flex items-center gap-3 text-white font-medium font-bold py-2 px-3 md:py-3 md:px-5 rounded focus:outline-none focus:shadow-outline duration-300 transition-colors rounded-lg";
